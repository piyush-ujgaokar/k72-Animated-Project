...
const ProjectCards = (props) => {
  return (
      ...
      <>
          <div className='lg:hover:rounded-[2.8vw] rounded-2xl group relative transition-all overflow-hidden lg:w-1/2 w-full lg:h-full h-[70vh]'>
            <img className='w-full h-full object-cover' src={props.image1} alt="" />
              <div className='absolute lg:flex lg:items-center transition-all lg:justify-center lg:left-0 left-10 lg:top-0 h-full w-full bg-black/10'>
